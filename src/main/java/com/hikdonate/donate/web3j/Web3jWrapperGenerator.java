package com.hikdonate.donate.web3j;

import java.io.IOException;

public class Web3jWrapperGenerator { // web3j의 경로
    private static final String WEB3J_PATH = "../../Users/yhyh1/.web3j/web3j-cli-shadow-1.6.0/bin/web3j.bat";
    ...
    private static final String PACKAGE_NAME = "com.hikdonate.donate.web3j.web3jAPI.contracts"; // 생성될 Java 클래스의 패키지 이름
